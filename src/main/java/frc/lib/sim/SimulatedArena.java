...
public class SimulatedArena {
    ...
    private Set<SimulatedRobot> robots = new HashSet<>();
    private int id = 0;
     ...
     */
    public SimulatedRobot newRobot() {
        SimulatedRobot dt = new SimulatedRobot(this.id++);
        robots.add(dt);
        return dt;
    }
     ...
     */
    public void update(double dt) {
        robots: for (SimulatedRobot robot : this.robots) {
