...
public class SwerveModuleTalonAngle implements SwerveModuleAngleIO {
    ...
    public SwerveModuleTalonAngle(int _id, ModuleConfig config) {
        ...
        BaseStatusSignal.setUpdateFrequencyForAll(Constants.Swerve.odometryFrequency,
            angleMotorPosition);
        BaseStatusSignal.setUpdateFrequencyForAll(50.0, angleMotorVelocity, angleMotorAppliedVolts,
            angleMotorCurrent, angleAbsolutePosition);
    ...
    public void updateAngleInputs(SwerveModuleAngleInputs inputs) {
        var angleStatus = BaseStatusSignal.refreshAll(angleMotorPosition, angleMotorVelocity,
        ...
        inputs.encoderConnected = angleEncoderStatus.isOK();
